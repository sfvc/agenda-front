  ...
  return (
    <div className="container">
      <div className="options">
        ...
        <select id="fontName" className="adv-option-button" onChange={handleAdvancedChange}></select>
        <select id="fontSize" className="adv-option-button" onChange={handleAdvancedChange}></select>
      </div>
      <div id="text-input" ref={writingAreaRef} contentEditable="true"></div>
