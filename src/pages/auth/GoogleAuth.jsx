...
const GoogleAuth = () => {
  ...
  return (
    ...
    <div className='bg-gradient-to-b from-red-800 to-red-600 hover:bg-gradient-to-t hover:from-red-800 hover:to-red-600 p-3 text-center rounded-lg flex flex-col justify-center'>
      ...
      <button disabled={isLoading} onClick={onClick} className='flex items-center justify-around bg-white border border-gray-300 rounded-lg px-4 py-2 shadow hover:shadow-lg transition duration-200'>
        ...
        <span className='text-gray-800 font-semibold'> Iniciar sesión</span>
      </button>
    </div>
